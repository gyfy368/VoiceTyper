...
1. 在 GitHub Releases 下载 `VoiceTyper-v1.1.2-win-x64.zip`
2. 解压到任意文件夹
3. 双击 `VoiceTyper.exe`
...
产物：`dist\VoiceTyper-v1.1.2-win-x64.zip`（exe + models + README）。
...
1. Download `VoiceTyper-v1.1.2-win-x64.zip` from GitHub Releases
2. Unzip anywhere
...
Output: `dist\VoiceTyper-v1.1.2-win-x64.zip`.
